/**
 * Seed script — populates Supabase with all current mock data.
 * Uses the service_role key (bypasses RLS) — NEVER run in browser.
 *
...
async function main() {
  console.log("\n🌱  Seeding Vikramaditya Metrology database...\n");
